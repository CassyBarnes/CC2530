...
class cl_CC2530_usart: public cl_hw
{
 ...
 public:
  ...
  virtual void BaudTick(void);
  virtual bool Shift_in(t_mem& Rxreg, bool& IPin);
  virtual void Shift_out(t_mem& Txreg, bool& OPin);
  virtual bool parity_check(t_mem byte);
  virtual void SCK(void);
  virtual bool ExtSCK(void);
